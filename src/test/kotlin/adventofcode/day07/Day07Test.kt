...
class Day07Test {
    ...
    fun `part two sample one`() {
        ...
        assertThat(amplifyWithFeedback(program, settings)).isEqualTo(139629729)
    }
    ...
    fun `part two sample two`() {
        ...
        val settings = listOf(9, 7, 8, 5, 6)

        assertThat(amplifyWithFeedback(program, settings)).isEqualTo(18216)
    }
    ...
    fun `part two`() {
        ...
        assertThat(optimalOutput?.value).isEqualTo(19741286)
        assertThat(optimalOutput?.settings).isEqualTo(listOf(9, 6, 5, 8, 7))
    }
